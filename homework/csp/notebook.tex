...
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{from} \PY{n+nn}{IPython.display} \PY{k+kn}{import} \PY{n}{display}\PY{p}{,} \PY{n}{HTML}
        
        \PY{n}{display}\PY{p}{(}\PY{n}{HTML}\PY{p}{(}\PY{n}{data}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}\PYZdq{}\PYZdq{}}
        \PY{l+s+s2}{\PYZlt{}style\PYZgt{}}
        \PY{l+s+s2}{    div\PYZsh{}notebook\PYZhy{}container    \PYZob{} width: 40}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{; \PYZcb{}}
        \PY{l+s+s2}{    div\PYZsh{}menubar\PYZhy{}container     \PYZob{} width: 65}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{; \PYZcb{}}
        \PY{l+s+s2}{    div\PYZsh{}maintoolbar\PYZhy{}container \PYZob{} width: 99}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{; \PYZcb{}}
        \PY{l+s+s2}{\PYZlt{}/style\PYZgt{}}
...
<IPython.core.display.HTML object>
    ...
    \subsubsection{LAURENT Thomas}\label{laurent-thomas}

M2 ia csp

    \section{Latin Square}\label{latin-square}

    Un \emph{Latin square} d'ordre \textbf{n} est un carré de \textbf{n x n}
dimension remplit avec \textbf{n} sumboles différents. Chaque lignes et
colonnes douvent contenir au plus un seul occurance du même symbole.

    Ceci est un \emph{Latin Square} valide:
...
\end{verbatim}
    ...
    On dit que deux \emph{Latin Squares} sont orthogonal que si la
superposition de ses deux tableaux forment un tableau où aucun élement
n'apparait plus d'une fois:

Ceci sont deux \emph{Latin Squares} orthogonal:
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{k}{def} \PY{n+nf}{model}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
            \PY{n}{a} \PY{o}{=} \PY{n}{array}\PY{p}{(}\PY{n}{dimensions}\PY{o}{=}\PY{p}{(}\PY{n}{n}\PY{p}{,}\PY{n}{n}\PY{p}{)}\PY{p}{,} \PY{n}{domain}\PY{o}{=}\PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{)}
        
            \PY{k}{for} \PY{n}{line} \PY{o+ow}{in} \PY{n}{a}\PY{p}{:}
                \PY{n}{alldifferent}\PY{p}{(}\PY{n}{line}\PY{p}{)}
        
            \PY{k}{for} \PY{n}{column} \PY{o+ow}{in} \PY{n}{a}\PY{o}{.}\PY{n}{Transpose}\PY{p}{:}
                \PY{n}{alldifferent}\PY{p}{(}\PY{n}{column}\PY{p}{)}
\end{Verbatim}
...
assigner les valeurs de la première ligne et colonne:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{def} \PY{n+nf}{model}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
            \PY{n}{a} \PY{o}{=} \PY{n}{array}\PY{p}{(}\PY{n}{dimensions}\PY{o}{=}\PY{p}{(}\PY{n}{n}\PY{p}{,}\PY{n}{n}\PY{p}{)}\PY{p}{,} \PY{n}{domain}\PY{o}{=}\PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{)}
            
            \PY{n}{a}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}
            \PY{n}{a}\PY{o}{.}\PY{n}{Transpose}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}
...
\end{Verbatim}
    ...
    On remarque aussi une symétrie diagonale, chaque éléments dans le coté
en bas à gauche et le même en haut à droite:
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{model}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
            \PY{n}{a} \PY{o}{=} \PY{n}{array}\PY{p}{(}\PY{n}{dimensions}\PY{o}{=}\PY{p}{(}\PY{n}{n}\PY{p}{,}\PY{n}{n}\PY{p}{)}\PY{p}{,} \PY{n}{domain}\PY{o}{=}\PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{)}
            
            \PY{n}{a}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}
            \PY{n}{a}\PY{o}{.}\PY{n}{Transpose}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}
            
            \PY{k}{for} \PY{n}{x}\PY{p}{,}\PY{n}{y} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{,}\PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
                \PY{n}{a}\PY{p}{[}\PY{n}{x}\PY{p}{]}\PY{p}{[}\PY{n}{y}\PY{p}{]} \PY{o}{==} \PY{n}{a}\PY{p}{[}\PY{n}{y}\PY{p}{]}\PY{p}{[}\PY{n}{x}\PY{p}{]}
...
\end{Verbatim}
    ...
    \subsubsection{Certain sont même très simple à
raisoudre}\label{certain-sont-muxeame-truxe8s-simple-uxe0-raisoudre}
...
\end{verbatim}
    ...
    Chaque ligne est identique à celle du dessus sauf qu'on n'a inséré le
première élement au bout de la liste, ce qui rend le problème
trivialement résolvable:

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{model}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
            \PY{n}{a} \PY{o}{=} \PY{n}{array}\PY{p}{(}\PY{n}{dimensions}\PY{o}{=}\PY{p}{(}\PY{n}{n}\PY{p}{,}\PY{n}{n}\PY{p}{)}\PY{p}{,} \PY{n}{domain}\PY{o}{=}\PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{)}
            
            \PY{n}{tmp} \PY{o}{=} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}
            \PY{k}{for} \PY{n}{line} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
                \PY{n}{a}\PY{p}{[}\PY{n}{line}\PY{p}{]} \PY{o}{=} \PY{n}{tmp}
                \PY{n}{tmp} \PY{o}{=} \PY{n}{tmp}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]} \PY{o}{+} \PY{n}{tmp}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
\end{Verbatim}
